...
# 用法:
#   bash extract_chr_ends_1Mb.sh genome.fa out_prefix [window_bp]
# 示例:
#   bash extract_chr_ends_1Mb.sh genome.fa chr_ends 1000000
#
# 输出:
#   out_prefix.5p_1Mb.fa   (所有chr的5'端窗口合并在一个fa)
#   out_prefix.3p_1Mb.fa   (所有chr的3'端窗口合并在一个fa)
